...
export const Icons = {
  ...
  grid:   (p: P = {}) => <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" {...p}><rect x="1" y="1" width="6" height="6" rx="1.5"/><rect x="9" y="1" width="6" height="6" rx="1.5"/><rect x="1" y="9" width="6" height="6" rx="1.5"/><rect x="9" y="9" width="6" height="6" rx="1.5"/></svg>,
  rows:   (p: P = {}) => <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" {...p}><rect x="1" y="2" width="14" height="3.5" rx="1"/><rect x="1" y="6.5" width="14" height="3.5" rx="1"/><rect x="1" y="11" width="14" height="3.5" rx="1"/></svg>,
}
